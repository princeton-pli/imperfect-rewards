...
class PolicyTrainerRayProcess(RayProcess):
    ...
    def setup_model_update_group(self, vllm_engines):
        ...
        if self.rank == 0:
            ...
            # In single_gpu_mode, both the trainer and vLLM engine share the same GPU.
            # NCCL doesn't support multiple ranks on the same physical GPU, so use gloo instead.
            if self.args.single_gpu_mode and backend == "nccl":
                print(
                    "WARNING:"
    ...
    async def reward_fn(
        ...
        if args.apply_verifiable_reward:
            with Timer("[Data Preparation Thread] Calculating rewards -- 🏆 Applying verifiable reward"):
                ...
                # Log raw (unweighted) scores for r_ans and r_format analysis
                raw_score_lists = defaultdict(list)
