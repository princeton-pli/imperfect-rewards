...
from imperfect_rewards.arguments import DatasetArguments, DatasetReLabelArguments
...
from imperfect_rewards.data import PreferenceDatasetCreator
...
def main():
    ...
    path_for_saving = config.relabel_config.output_dir + (f"_seed_{config.seed}_split_seed_{config.relabel_config.train_split_seed}_"
                                                          f"rid_{run_id}")
