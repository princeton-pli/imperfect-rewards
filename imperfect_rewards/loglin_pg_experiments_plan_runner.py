...
from controlled_loglin_pg.experiments.log_linear_policy_grad_experiment import LogLinearPolicyGradientExperiment
...
def main():
    ...
    experiment = LogLinearPolicyGradientExperiment()
